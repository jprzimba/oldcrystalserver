...
local node1 = keywordHandler:addKeyword({'yes'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'What city do you wish to live in? {Karmia} or {Inferno}'})
	local node2 = node1:addChildKeyword({'karmia'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, town = 1, destination = {x=438, y=504, z=8}, text = 'Karmia, eh? So what vocation do you wish to become? {Sorcerer}, {druid}, {paladin} or {knight}?'})
		...
		node3 = node2:addChildKeyword({'knight'}, StdModule.say, {npcHandler = npcHandler, vocation = 4, onlyFocus = true, text = 'A mighty warrior. Is that your final decision? This decision is irreversible!'})
			node3:addChildKeywordNode(yesNode)
			node3:addChildKeywordNode(noNode)
	node2 = node1:addChildKeyword({'inferno'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, town = 1, destination = {x=481, y=429, z=7}, text = 'Inferno, eh? So what vocation do you wish to become? {Sorcerer}, {druid}, {paladin} or {knight}?'})
