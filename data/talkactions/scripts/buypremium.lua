...
function onSay(cid, words, param, channel)
    local playerPremiumDays = getPlayerPremiumDays(cid)

    if playerPremiumDays > config.maxDays then
        doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "You cannot buy more than " .. config.days + config.maxDays .. " days of Premium Account.")
