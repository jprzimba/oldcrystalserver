...
---Karmia City Simples
	...
	elseif item.uid == 5069 then
   	...
   	elseif item.uid == 5031 then
   		...
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "You have found a 200 Gps.")
...
---Desert City
	...
	elseif item.uid == 5074 then
   	...
   	elseif item.uid == 5043 then
   		...
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "You have found a Lady Armor.")
   	...
   	elseif item.uid == 5044 then
   		...
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "You have found a Lady Helmet.")
...
---RookGuard
   	...
   	elseif item.uid == 5062 then
   		...
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "You have found a Brass Shield.")
   			doPlayerAddItem(cid, 2478, 1)
