...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnumIn("configKeys", ConfigManager::REMOVE_WEAPONS_CHARGES)
	...
	registerEnumIn("configKeys", ConfigManager::BED_REQUIRE_PREMIUM)
	...
	registerEnumIn("configKeys", ConfigManager::AUTO_SAVE_EACH_MINUTES)
